...
import { useCreateAluno } from "@/lib/api-client";
...
export default function AlunoForm() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    createAluno.mutate({ data: values }, {
      onSuccess: () => {
        toast({ title: "Sucesso", description: "Aluno cadastrado com sucesso." });
        router.push("/alunos");
      },
      onError: () => {
        toast({ title: "Erro", description: "Ocorreu um erro ao cadastrar o aluno.", variant: "destructive" });
      }
    });
  }
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input maxLength={2} placeholder="UF" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <div className="flex justify-end gap-4 pt-4 border-t">
              ...
              <Button type="submit" disabled={createAluno.isPending}>
